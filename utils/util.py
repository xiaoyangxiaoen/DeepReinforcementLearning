...
import inspect
import heapq, random
from functools import cmp_to_key    # added by minisheep.shaun for python3


class FixedRandom:
    def __init__(self):
        tmp = (2147483648, 507801126, 683453281, 310439348, 2597246090,
...
class Counter(dict):
    ...
    def argMax(self):
        ...
        #all = self.items()         # for python 2  modified by minisheep.shaun
        all = list(self.items())    # for python3   modified by minisheep.shaun
    ...
    def sortedKeys(self):
        ...
        ['second', 'third', 'first']
        """
        #sortedItems = self.items()         # for python 2  modified by minisheep.shaun
        sortedItems = list(self.items())    # for python 3  modified by minisheep.shaun
        #compare = lambda x, y:  sign(y[1] - x[1])  # for python3 commented by minisheep.shaun
        #sortedItems.sort(cmp=compare)              # for python3 commented by minisheep.shaun
